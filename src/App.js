...
import ProfileDisplay from "./components/Home/ProfileDisplay.jsx";
      ...
      <Router>
        <UserAuthContextProvider>
          <Routes>
            ...
            <Route exact path="/:username/forgotPassword" element={<ForgotPassword />} />
            <Route exact path="/:username/profile" element={<ProfileDisplay />} />
            {/* <Route
              exact
